...
def hmmsearch(output_hmmbuild, seq_db, output_hmmsearch_raw,
    ...
    try:
        cmd_hmmsearch = "hmmsearch -E 1.0e-75 -A {} {} {} ".format(output_hmmsearch_raw, output_hmmbuild, seq_db)
        subprocess.check_call(cmd_hmmsearch, shell=True)
    except FileNotFoundError:
        print("File was not found, stopping program")
        exit()
    ...
    try:
        ...
        print("The file can't be found, stopping program")
        exit()
...
def loop_necessary(amount_added, result_fasta, input_fasta, seq_db):
    ...
    if amount_added >= 5:
        ...
        muscle(result_fasta, "final_msa.aln -maxiters 2")
...
def main():
    ...
    try:
        ...
        print("Input file was not found, stopping program")
        exit()
